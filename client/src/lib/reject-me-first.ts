...
export const copy = {
  en: {
    ...
    pageIntroReview: "Your selected committee agents review the same brief in parallel, each from their own expertise.",
  ...
  ar: {
    ...
    pageIntroReview: "وكلاء اللجنة المختارون يراجعون نفس الملخص بالتوازي، كل واحد من تخصصه.",
